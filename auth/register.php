                                    ...
                                    <form class="user" method="post" action="proses_register.php">
                                        <div class="form-group">
                                            <input type="text" name="namalengkap" class="form-control form-control-user"
                                                id="exampleInputNamaLengkap" aria-describedby="emailHelp"
                                                placeholder="Masukkan nama lengkap">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="lembaga" class="form-control form-control-user"
                                                id="exampleInputNamaLembaga" aria-describedby="emailHelp"
